...
function Source:is_available()
  ...
  if prev_sibling_name == "class" or prev_sibling_name == "className" then
    self.current_selector = "class"
  elseif prev_sibling_name == "id" then
    self.current_selector = "id"
  end

  if prev_sibling_name == "class" or prev_sibling_name == "className" or prev_sibling_name == "id" and type == "quoted_attribute_value" then
    return true
  end
